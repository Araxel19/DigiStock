...
__decorate([
    (0, typeorm_1.ManyToOne)(() => organization_entity_1.Organization, organization => organization.products),
...
__decorate([
    (0, typeorm_1.Column)({ type: 'uuid', name: 'location_id', nullable: true }),
    __metadata("design:type", String)
], Product.prototype, "locationId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => location_entity_1.Location, location => location.products, { onDelete: 'SET NULL' }),
...
exports.Product = Product = __decorate([
    ...
    (0, typeorm_1.Unique)(['organizationId', 'code'])
], Product);
