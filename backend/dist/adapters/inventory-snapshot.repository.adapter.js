...
exports.InventorySnapshotRepositoryAdapter = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const digistock_business_logic_1 = require("digistock-business-logic");
let InventorySnapshotRepositoryAdapter = class InventorySnapshotRepositoryAdapter {
    constructor(inventorySnapshotRepository) {
...
exports.InventorySnapshotRepositoryAdapter = InventorySnapshotRepositoryAdapter;
exports.InventorySnapshotRepositoryAdapter = InventorySnapshotRepositoryAdapter = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(digistock_business_logic_1.InventorySnapshot)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], InventorySnapshotRepositoryAdapter);
//# sourceMappingURL=inventory-snapshot.repository.adapter.js.map