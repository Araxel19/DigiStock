...
exports.PlanillaItemRepositoryAdapter = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const digistock_business_logic_1 = require("digistock-business-logic");
let PlanillaItemRepositoryAdapter = class PlanillaItemRepositoryAdapter {
    constructor(planillaItemRepository) {
...
exports.PlanillaItemRepositoryAdapter = PlanillaItemRepositoryAdapter;
exports.PlanillaItemRepositoryAdapter = PlanillaItemRepositoryAdapter = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(digistock_business_logic_1.PlanillaItem)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], PlanillaItemRepositoryAdapter);
//# sourceMappingURL=planilla-item.repository.adapter.js.map